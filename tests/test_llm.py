...
class TestGenerateCypher:
    ...
    def test_returns_cypher(self, mock_litellm: MagicMock) -> None:
    ...
    @patch("clawgraph.llm.litellm")
    def test_raises_on_empty(self, mock_litellm: MagicMock) -> None:
        from clawgraph.llm import generate_cypher
    ...
    @patch("clawgraph.llm.litellm")
    def test_raises_on_api_error(self, mock_litellm: MagicMock) -> None:
        from clawgraph.llm import generate_cypher
...
class TestInferOntology:
    ...
    @patch("clawgraph.llm.litellm")
    def test_parses_json_response(self, mock_litellm: MagicMock) -> None:
    ...
    @patch("clawgraph.llm.litellm")
    def test_strips_code_fences(self, mock_litellm: MagicMock) -> None:
        from clawgraph.llm import infer_ontology
    ...
    @patch("clawgraph.llm.litellm")
    def test_raises_on_bad_json(self, mock_litellm: MagicMock) -> None:
        from clawgraph.llm import infer_ontology
